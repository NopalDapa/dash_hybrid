  ...
  <div class="basis-1/3 p-4">
    ...
    <div class="flex flex-col md:flex-row gap-4 items-start">
      ...
      <div class="flex flex-col items-center space-y-2">
        ...
        <div class="grid grid-cols-3 gap-2 w-full">
          <button
            class="bg-white border border-blue-500 text-blue-500 font-semibold py-2 px-4 rounded transition duration-200 ease-in-out hover:bg-blue-500 hover:text-white"
            @click="nudgeTheta(-0.8)"
          >
            ⟲
          </button>
          <button
    ...
    <div class="mt-4 space-y-2">
      ...
      <div class="flex flex-col sm:flex-row gap-2 items-start sm:items-center">
        ...
        <button
          class="bg-white border border-red-500 text-red-500 font-semibold py-2 px-4 rounded transition duration-200 ease-in-out hover:bg-red-500 hover:text-white"
          @click="stopAutopilot"
        >
          Stop Go
        </button>
...
export default {
  ...
  methods: {
    ...
    publishVelocity() {
      ...
      // UI axes: X up, Y right
      // ROS axes: X right, Y up
      // => swap when publishing into ROS topics
      const cmdLinearX = this.vel.vy;
      const cmdLinearY = this.vel.vx;

      const twist = new ROSLIB.Message({
        linear: { x: cmdLinearX, y: cmdLinearY, z: 0 },
